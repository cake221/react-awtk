...
if(globalThis.__AwtkSnapshot){
  ...
  VALUE_CHANGING : TEventType.VALUE_CHANGING,
  PAINT : TEventType.PAINT,
  BEFORE_PAINT : TEventType.BEFORE_PAINT,
  AFTER_PAINT : TEventType.AFTER_PAINT,
  PAINT_DONE : TEventType.PAINT_DONE,
  ...
  eventFunName = {
    ...
    VALUE_CHANGING : TEventTypePatch.VALUE_CHANGING,
    PAINT : TEventTypePatch.PAINT,
    BEFORE_PAINT : TEventTypePatch.BEFORE_PAINT,
    AFTER_PAINT : TEventTypePatch.AFTER_PAINT,
    PAINT_DONE : TEventTypePatch.PAINT_DONE,
