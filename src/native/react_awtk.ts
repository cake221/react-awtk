import { TEventTypePatch } from "./awtkPatch"
export interface eventFun {
  (evt?:any):TRet;
}

let eventFunName:any;
if(globalThis.__AwtkSnapshot){
  ...
  onValueChanging : TEventType.VALUE_CHANGING,
  onPaint : TEventType.PAINT,
  onBeforePaint : TEventType.BEFORE_PAINT,
  onAfterPaint : TEventType.AFTER_PAINT,
  onPaintDone : TEventType.PAINT_DONE,
  ...
  eventFunName = {
    ...
    // onClick : TEventType.POINTER_ENTER,
    // onClick : TEventType.POINTER_LEAVE,
    onLongPress : TEventTypePatch.LONG_PRESS,
    onClick : TEventTypePatch.CLICK,
    // onClick : TEventType.FOCUS,
    // onClick : TEventType.BLUR,
    // onClick : TEventType.KEY_DOWN,
    // onClick : TEventType.KEY_DOWN_BEFORE_CHILDREN,
    ...
    // onClick : TEventType.WILL_MOVE_RESIZE,
    // onClick : TEventType.MOVE_RESIZE,
    onValueWillChange : TEventTypePatch.VALUE_WILL_CHANGE,
    onValueChanged : TEventTypePatch.VALUE_CHANGED,
    onValueChanging : TEventTypePatch.VALUE_CHANGING,
    onPaint : TEventTypePatch.PAINT,
    onBeforePaint : TEventTypePatch.BEFORE_PAINT,
    onAfterPaint : TEventTypePatch.AFTER_PAINT,
    onPaintDone : TEventTypePatch.PAINT_DONE,

    // LOCALE_CHANGED : TEventTypePatch.LOCALE_CHANGED,
    // onClick : TEventType.ANIM_START,
    // onClick : TEventType.ANIM_STOP,
    // onClick : TEventType.ANIM_PAUSE,
    // onClick : TEventType.ANIM_ONCE,
